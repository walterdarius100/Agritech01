...
export function normalizeArticle(article = {}) {
  ...
  return {
    ...
    author: article.author || article.author_name || 'Agri-tech',
    authorId: article.author_id || article.authorId || '',
    author_id: article.author_id || article.authorId || '',
    content: Array.isArray(article.content) ? article.content.join('\n\n') : (article.content_html || article.contentHtml || article.content || ''),
    contentHtml: article.content_html || article.contentHtml || article.content || '',
    content_html: article.content_html || article.contentHtml || article.content || '',
