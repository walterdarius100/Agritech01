...
if (window.emailjs) {
  ...
  const courses = [
    ...
    { title: 'Formation en élevage de poules pondeuses', image: 'assets/images/poule-pondeuse.jpg', level: 'Élevage', duration: '4 modules', status: 'Bientôt disponible', price: 'Préinscription ouverte', text: 'Apprenez les bases essentielles pour démarrer et gérer un élevage de poules pondeuses de manière structurée et rentable.', bonus: 'Alerte au lancement', cta: 'Être informé', need: 'Formation poule pondeuse', cardLink: true }
  ];
